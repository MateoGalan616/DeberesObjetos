...
const useCandyCreator = () => {
    ...
    const [count, setCount] = useState<number>(0); // Nuevo estado para el contador
    ...
    return (
        <div>
            ...
            <div>
                ...
                <br />
                <Text>Count: {count}</Text> {/* Mostrar el contador */}
            </div>
        </div>
    );
}
